...
- (id)initWithFrame:(CGRect)frame menuItems:(NSArray *)aMenuItems
{
    ...
    if (self)
    {
        ...
        [self.containerButton setBackgroundColor:CLEARCOLOR];
        ...
        UITableView *menuItemsTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 10, frame.size.width, frame.size.height - 10)];
